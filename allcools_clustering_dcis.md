...
--bind /rsrch5/home/genetics/NAVIN_LAB/Ryan/projects/metact/250526_RMMM_scalebio_dcis \
--bind /rsrch4/scratch/genetics/rmulqueen \
$sif 

projDir="/rsrch5/home/genetics/NAVIN_LAB/Ryan/projects/metact/250526_RMMM_scalebio_dcis"
cd ${projDir}/postprocessing/bismark/sc_allcool

cat ${projDir}/report/DCIS/csv/DCIS.allCells.csv | grep "pass" | tail -n +1 >> ${projDir}/cell_metadata.csv
```
...
metadata_path="/rsrch5/home/genetics/NAVIN_LAB/Ryan/projects/metact/250526_RMMM_scalebio_dcis/cell_metadata.csv"
mcds_path="/rsrch5/home/genetics/NAVIN_LAB/Ryan/projects/metact/250526_RMMM_scalebio_dcis/postprocessing/bismark/sc_allcool/5k_mcds/data.mcds"
allcool_path="/rsrch5/home/genetics/NAVIN_LAB/Ryan/projects/metact/250526_RMMM_scalebio_dcis/postprocessing/bismark/sc_allcool/5k_mcds"
var_dim='chrom5k'
...
outdir="/rsrch5/home/genetics/NAVIN_LAB/Ryan/projects/metact/250526_RMMM_scalebio_dcis/postprocessing/bismark/sc_allcool"
plt.savefig(outdir+'/DCIS.mCG-5K-clustering.png')


mcad.write_h5ad(outdir+'/DCIS.mCG-5K-clustering.h5ad')
mcad.obs.to_csv(outdir+'/DCIS.ClusteringResults.csv.gz')
...
xargs zcat < DCIS.Cluster_0.allcool.tsv \
| awk 'OFS="\t" {print $1,$2,$2,$3,$4,$5,$6,$7}' \
| sort -T . --parallel=10 -k1,1 -k2,2n -k3,3 > DCIS.Cluster_0.sort.allcool 

bedtools merge -s -c 6,7 -o sum,sum -i DCIS.Cluster_0.sort.allcool 
| awk 'OFS="\t" {if($6/$7<0.9) {$8=0} else {$8=1}; print $1,$2,$4,$5,$6,$7,$8}' > DCIS.Cluster_0.allcool 

| bgzip -@10 > DCIS.Cluster_0.allcool.gz

tabix -b 2 -e 2 -s 1 DCIS.Cluster_0.allcool.gz
...
allcools merge-allc \
    --allc_paths DCIS.Cluster_0.allcool.tsv \
    --output_path DCIS_Cluster_0.gz \
